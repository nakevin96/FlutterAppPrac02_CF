...
import 'package:prac02riverpod/screen/code_generation_screen.dart';
...
import 'package:prac02riverpod/screen/listen_provider_screen.dart';
import 'package:prac02riverpod/screen/provider_screen.dart';
import 'package:prac02riverpod/screen/select_provider_screen.dart';
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const ListenProviderSreen(),
                  ),
                );
              },
              child: const Text('ListenProviderSreen'),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
